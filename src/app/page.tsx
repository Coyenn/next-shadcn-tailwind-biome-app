export default function Home() {
  return (
    <div className="grid bg-background min-h-screen">
      <main className="relative mx-auto max-w-2xl px-6 pb-24 pt-8 sm:pb-32 lg:px-10 w-full">
        <svg
        ...
        <h1 className="text-center font-medium text-2xl md:text-3xl xl:text-5xl font-instrument-serif mt-2 sm:mt-4">
          Welcome to Next.js!
        </h1>
